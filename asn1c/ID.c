...
static const asn_INTEGER_enum_map_t asn_MAP_ID_value2enum_1[] = {
	{ 0,	15,	"rrcSetupRequest" },
	{ 1,	8,	"rrcSetup" },
	{ 2,	16,	"rrcSetupComplete" }
};
static const unsigned int asn_MAP_ID_enum2value_1[] = {
	1,	/* rrcSetup(1) */
	2,	/* rrcSetupComplete(2) */
	0	/* rrcSetupRequest(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_ID_specs_1 = {
	asn_MAP_ID_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_ID_enum2value_1,	/* N => "tag"; sorted by N */
